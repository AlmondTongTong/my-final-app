          ...
          {adminSelectedStudent ? (
            ...
            <>
              ...
              <div className="text-left p-4 border border-slate-600 rounded-xl mt-6"> 
                ...
                <h4 className="font-semibold mt-4 text-2xl text-gray-300">💬 Posts with Peers' Replies</h4>
                ...
                <h4 className="font-semibold mt-4 text-2xl text-gray-300">Posts without Peers' Replies</h4>
