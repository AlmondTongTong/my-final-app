        ...
        setQuestionsLog(prevLogs => {
            ...
            snapshot.docChanges().forEach(change => {
                ...
                if (change.type === "added") {
                    if (!newLogs.some(log => log.id === data.id)) {
                        newLogs.unshift(data); // Add to the beginning
                    }
                }
